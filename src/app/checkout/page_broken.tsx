...
export default function CheckoutPage() {
  ...
  const handleProceedToPayment = () => {
    if (!selectedShippingId) {
      alert('LÃ¼tfen teslimat adresi seÃ§in!');
      return;
    }
    if (!useSameAddress && !selectedBillingId) {
      alert('LÃ¼tfen fatura adresi seÃ§in!');
      return;
    }
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center">
            {[
              { id: 'cart-review', label: 'Sepet Ã–zeti', icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z' },
              { id: 'address-selection', label: 'Adres SeÃ§imi', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
              { id: 'payment', label: 'Ã–deme', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
            ].map((step, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Sepet Ã–zeti</h2>
                ...
                {items.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 mb-4">Sepetiniz boÅŸ</p>
                        ...
                        <div className="text-right">
                          {item.personalOfferId && item.originalPrice && (
                            <div className="text-sm text-gray-400 line-through">
                              â‚º{(item.originalPrice * item.quantity).toFixed(2)}
                            </div>
                          )}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
                <h3 className="text-xl font-bold text-gray-900 mb-4">SipariÅŸ Ã–zeti</h3>
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span>Kargo:</span>
                    <span>{shipping === 0 ? 'Ãœcretsiz' : `â‚º${shipping.toFixed(2)}`}</span>
                  </div>
                  {shipping === 0 && (
                    <p className="text-xs text-green-600">ğŸ‰ 500 TL ve Ã¼zeri sipariÅŸlerde kargo bedava!</p>
                  )}
        ...
        {currentStep === 'address-selection' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                {addresses.length === 0 ? (
                  <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                    ...
                    <p className="text-gray-600 mb-4">KayÄ±tlÄ± adresiniz bulunmuyor</p>
                    <Link
                      href="/account?tab=addresses"
                      target="_blank"
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              {address.isDefault && (
                                <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">VarsayÄ±lan</span>
                              )}
                            </div>
                ...
                <label className="flex items-center gap-2 mb-4 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (checked) {
                        // Teslimat adresinin fatura adresi olarak kullanÄ±labilirliÄŸini kontrol et
                        const shippingAddress = addresses.find(a => a.id === selectedShippingId);
                        
                        if (!shippingAddress) {
                          alert('LÃ¼tfen Ã¶nce teslimat adresi seÃ§in');
                          return;
                        }
                        
                        if (!shippingAddress.isBillingAddress) {
                          alert('SeÃ§ili teslimat adresi fatura adresi olarak iÅŸaretlenmemiÅŸ. LÃ¼tfen fatura bilgilerini iÃ§eren bir adres seÃ§in veya ayrÄ± bir fatura adresi belirleyin.');
                          return;
                        }
                        
                        if (!shippingAddress.companyName || !shippingAddress.taxNumber || !shippingAddress.taxOffice) {
                          alert('SeÃ§ili adresin fatura bilgileri eksik (Unvan, Vergi No, Vergi Dairesi). LÃ¼tfen fatura bilgilerini tamamlayÄ±n veya baÅŸka bir adres seÃ§in.');
                          return;
                        }
                  ...
                  />
                  <span className="text-gray-700 font-medium">Teslimat adresi ile aynÄ±</span>
                </label>
                  ...
                  <div className="space-y-4">
                    {addresses.filter(a => a.isBillingAddress && a.companyName && a.taxNumber && a.taxOffice).length === 0 ? (
                      <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                        ...
                        <p className="text-gray-600 mb-2 font-semibold">Fatura bilgisi iÃ§eren adresiniz bulunmuyor</p>
              ...
              {/* Order Notes */}
              <div className="bg-white rounded-xl shadow-md p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">SipariÅŸ Notu (Opsiyonel)</h2>
                <textarea
                  value={notes}
                  onChange={(e) => setNotes(e.target.value)}
                  placeholder="SipariÅŸiniz hakkÄ±nda eklemek istediÄŸiniz notlar..."
                  rows={4}
        ...
        {currentStep === 'payment' && (
          <div className="text-center py-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Ã–deme EkranÄ±</h2>
            <p className="text-gray-600">Bu bÃ¶lÃ¼m ÅŸu anda hazÄ±rlanÄ±yor...</p>
            <button
